...
export interface ServiceProviderType {
    ...
    profession: Types.ObjectId, services: { service: Types.ObjectId, price: number, priceUnit?: PriceUnit }[],
    ...
    bookings?: Types.ObjectId[], reviews?: Types.ObjectId[],
...
export { User, ServiceProvider, Service, Booking, Review }
